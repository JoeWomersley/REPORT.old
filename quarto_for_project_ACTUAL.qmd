...
saveWidget(dt_prog_raw, "data/HTML/surfaceome_prog.html", selfcontained = TRUE)
saveWidget(dt_hspc_raw, "data/HTML/surfaceome_hspc.html", selfcontained = TRUE)
saveWidget(dt_lthsc_raw, "data/HTML/surfaceome_lthsc.html", selfcontained = TRUE)
...
hspc <- read.csv("data/surfaceome_hspc.csv", row.names = 1)
prog <- read.csv("data/surfaceome_prog.csv", row.names = 1)
lthsc <- read.csv("data/surfaceome_lthsc.csv", row.names = 1)
```
...
prog_data <- read.csv("data/surfaceome_Prog.csv", row.names = 1)
hspc_data <- read.csv("data/surfaceome_hspc.csv", row.names = 1)
lthsc_data <- read.csv("data/surfaceome_lthsc.csv", row.names = 1)


# Combine the datasets into one matrix
# Assuming cells are in columns and genes in rows
combined_data <- cbind(prog_data, hspc_data, lthsc_data)
...
plot <- ggplot(gene_expression_SEM, aes(x = new_cell, y = Average_Expression, fill = Gene)) +
...
ggplot(qPCR_data_processed , aes(x = cell_type_grouped, y = Mmrn1_expression, fill = cell_type_grouped)) +
